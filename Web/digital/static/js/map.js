...
init = function initMap(){
  ...
  xmarkers.forEach((i) => {
    markers.push({coords: {lat:i[0][0], lng: i[0][1]},
    content: "<html><head></head><body><div class='card' style=' width: 200px; font-size: 12px; background-color: #fff; color: #222; padding: 10px; border: 0; '><div style='margin: 2px;' class='cardname'> <strong>Name:</strong> "+i[1]+" </div><div style='margin: 2px;' class='cardneed:'> <strong>Need</strong> Food</div><div style='margin: 2px;' class='carddescription'> <strong>Description:</strong> "+i[2]+" </div><div style='margin: 2px;' class='cardaddress'> <strong>Address:</strong> "+i[4]+" </div><div style='margin: 2px;' class='cardnumber'> <strong>Phone No.:</strong> "+i[3]+" </div><div style='text-align: center;'><a href='tel:1234567890'><div style=' padding: 5px; background-color: orangered; display: inline-block; margin: 2px; color: #222; font-size: 15px; box-shadow: 0px 2px 5px 0 rgba(0,0,0,.5); border-radius: 3px; '>I can help!</div></a></div></div></body></html>"})
  });
